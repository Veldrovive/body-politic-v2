...
/// </summary>
[Serializable]
public class StringReferenceEqualityCondition
{
    [Tooltip("Left side of the comparison.")]
    [SerializeField] private StringReference left = new StringReference();
    [Tooltip("Right side of the comparison.")]
    [SerializeField] private StringReference right = new StringReference();
...
/// <summary>
/// A ScriptableObject that checks if a set of StringReference are equal
/// </summary>
[CreateAssetMenu(menuName = "Conditions/Atomic/String Equality Condition", fileName = "StringEqualityConditionSO")]
public class StringEqualityConditionSO : AbstractConditionalSO
{
    ...
    [SerializeField] private List<StringReferenceEqualityCondition> conditions = new List<StringReferenceEqualityCondition>();
