...
/// </summary>
[Serializable]
public class FloatReferenceEqualityCondition
{
    [Tooltip("Left side of the comparison.")]
    [SerializeField] private FloatReference left = new FloatReference();
    [Tooltip("Right side of the comparison.")]
    [SerializeField] private FloatReference right = new FloatReference();
...
/// <summary>
/// A ScriptableObject that checks if a set of FloatReference are equal
/// </summary>
[CreateAssetMenu(menuName = "Conditions/Atomic/Float Equality Condition", fileName = "FloatEqualityConditionSO")]
public class FloatEqualityConditionSO : AbstractConditionalSO
{
    ...
    [SerializeField] private List<FloatReferenceEqualityCondition> conditions = new List<FloatReferenceEqualityCondition>();
